...
Implementation of initial K-block， real-valued Conv & ReLU.
"""
...
os.environ["CUDA_VISIBLE_DEVICES"] = "0"       #3--1， 2--0，1--3，0--2
...
[cost_0, cost, cost_ui] = compute_cost(Prediction, Ju, PhaseNumber)
...
#init_Weights = 'fs_Phase3_K' + '/CS_Saved_Model_652.ckpt' 
...
model_dir = 'fs_Phase%d_K' % (PhaseNumber)
...
#If you use this code only for testing, please commit lines 353-397
...
data = sio.loadmat('Train_Data_fs/data.mat' )
...
data = sio.loadmat('Test_Data_fs/data.mat' )
...
result_file_name = "PSNR_Results_fs.txt"
