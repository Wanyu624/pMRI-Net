...
Implementation of initial K-block with complex conv&relu
"""
...
def k_block(k_space):
    ...
    k0_real = k3_real + k_real
    k0_imag = k3_imag + k_imag
...
#init_Weights = 'pd_Phase3_K_complex' + '/CS_Saved_Model_70.ckpt' 
...
model_dir = 'pd_Phase%d_K_complex' % (PhaseNumber)
...
#If you use this code just for testing, please comment out lines 355-400
print("...................................")
